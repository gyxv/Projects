var ThreeBodyGlassSim = (() => {
  ...
  function createObjectSet(center) {
    ...
    if (choice < 0.2) {
      const star = { mass: 8 + Math.random() * 4, radius: 0.18 + Math.random() * 0.07, orbitCenter: center, orbitRadius: 0, omega: 0, phase: 0, color: randomOuterColor() };
      objs.push(star);
      const n = 2 + Math.floor(Math.random() * 3);
      for (let i = 0; i < n; i++) {
        const r = 3 + Math.random() * 5;
        const omega = Math.sqrt(star.mass / Math.pow(r, 3));
        const planet = { mass: 0.5 + Math.random() * 1.5, radius: 0.05 + Math.random() * 0.08, orbitCenter: center, orbitRadius: r, omega, phase: Math.random() * Math.PI * 2, color: randomOuterColor(), parent: star };
        objs.push(planet);
        if (Math.random() < 0.5) {
      ...
      const planet = { mass: 1 + Math.random() * 2, radius: 0.08 + Math.random() * 0.05, orbitCenter: center, orbitRadius: 0, omega: 0, phase: 0, color: randomOuterColor() };
      objs.push(planet);
      ...
      const planet = { mass: 0.8 + Math.random() * 1.2, radius: 0.08 + Math.random() * 0.06, orbitCenter: center, orbitRadius: 0, omega: 0, phase: 0, color: randomOuterColor(), ring: true };
      objs.push(planet);
    } else if (choice < 0.65) {
      ...
      for (let i = 0; i < count; i++) {
        objs.push({ mass: 5e-3 + Math.random() * 0.01, radius: 0.01 + Math.random() * 0.01, orbitCenter: center, orbitRadius: beltR + (Math.random() - 0.5) * 0.5, omega, phase: Math.random() * Math.PI * 2, color: "#aaaaaa" });
      }
    } else {
  ...
  function ThreeBodyGlassSim() {
    ...
    function spawnBlackHole() {
      ...
      const bh = { mass: 5e4, radius: 0.25, orbitCenter: pos, orbitRadius: 0, omega: 0, phase: 0, color: "#000000", type: "blackhole" };
